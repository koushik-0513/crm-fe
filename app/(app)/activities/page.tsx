  ...
  useEffect(() => {
    if (result && Array.isArray(result)) {
      if (page === 1) {
        ...
        const types = Array.from(new Set([...activities, ...result].map((a: TActivity) => a.activityType)));
        setActivityTypes(types);
      }
          ...
          <div className="flex flex-wrap items-center gap-4 mb-6">
            ...
            <div className="relative">
              <Button
                ...
                className={dateRange[0].startDate && dateRange[0].endDate ? "border-blue-500 bg-blue-50" : ""}
              >
