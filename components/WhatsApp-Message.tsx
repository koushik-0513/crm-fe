...
// ============================================================================
// WHATSAPP MESSAGE COMPONENT SPECIFIC TYPES
// ============================================================================

type TWhatsAppMessageProps = {
  className?: string;
}

export default function SMSMessage({ className }: TWhatsAppMessageProps) {
    ...
    try {
      ...
      if (result.success) {
        ...
        if (sendResult.success) {
          ...
          toast.error(`Failed to send message: ${sendResult.error}`);
        }
      } else {
  ...
  const handleGenerateMore = async (contactId: string) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        toast.success("More message versions generated!");
      }
    } catch (error) {
