...
//   return (
//     <>
//       {/* Mobile/Tablet Navbar - Shows on screens smaller than lg */}
//       <nav className="lg:hidden fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm border-b border-slate-200/50 shadow-sm">
